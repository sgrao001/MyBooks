...
# ![[image.jpeg | My description]] - Filename + description
# ![[image.jpeg | | 300px]] - Filename + size (no description)
# ![[image.jpeg | | 50%]] - Filename + percentage size
# ![[image.jpeg | | 400x300]] - Filename + dimensions
# ![[image.jpeg | | 400]] - Filename + auto-px size
# ![[image.jpeg | | | center]] - Filename + alignment only
# ![[image.jpeg | | | left]] - Filename + left alignment
# ![[image.jpeg | | | right]] - Filename + right alignment
# ![[image.jpeg | Description | 300px]] - Filename + description + size
# ![[image.jpeg | Description | 50%]] - Filename + description + percentage
# ![[image.jpeg | Description | 400x300]] - Filename + description + dimensions
# ![[image.jpeg | Description | 400]] - Filename + description + auto-px
# ![[image.jpeg | Description | | center]] - Filename + description + alignment
# ![[image.jpeg | Description | | left]] - Filename + description + left align
# ![[image.jpeg | Description | | right]] - Filename + description + right align
# ![[image.jpeg | | 300px | center]] - Filename + size + alignment
# ![[image.jpeg | | 50% | left]] - Filename + percentage + left align
# ![[image.jpeg | | 400x300 | right]] - Filename + dimensions + right align
# ![[image.jpeg | | 400 | center]] - Filename + auto-px + alignment
# ![[image.jpeg | Description | 300px | center]] - All parameters: centered
# ![[image.jpeg | Description | 300px | left]] - All parameters: left aligned
# ![[image.jpeg | Description | 300px | right]] - All parameters: right aligned
# ![[image.jpeg | Description | 50% | center]] - All: percentage + centered
# ![[image.jpeg | Description | 400x300 | left]] - All: dimensions + left
# ![[image.jpeg | Description | 400x300 | right]] - All: dimensions + right
# Size Options:
# 
# 300px - Fixed pixels
# 50% - Percentage width
...
def convert_inline_images(content):
    """Fixed parser that handles alignment correctly"""
    ...
    def replace_image(match):
        ...
        if size_spec:
            if size_spec.isdigit():
                style_attr = f' style="width: {size_spec}px;"'
            elif 'x' in size_spec:  # Handle dimensions like 400x300
                width, height = size_spec.split('x')
                style_attr = f' style="width: {width}px; height: {height}px;"'
            else:
                style_attr = f' style="width: {size_spec};"'
        
        # Apply alignment class
        alignment_class = f" image-align-{alignment}"
        
        # Create HTML
        image_html = f'<img src="{escape(image_filename)}" alt="Image"{style_attr}>'
        caption_html = f'<div class="image-caption-popup">{escape(description)}</div>' if description else ''
